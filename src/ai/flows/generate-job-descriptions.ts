...
/**
 * @fileOverview Generates job descriptions based on a job title and desired qualifications.
 *
...
const GenerateJobDescriptionInputSchema = z.object({
  ...
  qualifications: z.string().describe('The desired qualifications for the job.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert HR assistant, specialized in writing compelling job descriptions.

  Based on the job title and desired qualifications, generate a job description.
